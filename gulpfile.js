...
var 
	...
	js_bundle = {
		betterbodyLandingMain: [
			paths.src + "js/general.js"
		],
		betterbodyLandingMainfilename: 'betterbodyLandingMain' + ver + '.min.js',
		out: paths.dest + 'js/'
	},
...
gulp.task('betterbodyLandingMain_bundle', function () {
	return gulp.src(js_bundle.betterbodyLandingMain)
	.pipe(concat(js_bundle.betterbodyLandingMainfilename))
	.pipe(minify({
		ext:{
			min: '.js'
		},
...
gulp.task("js_bundle", ["betterbodyLandingMain_bundle"], function () {
});
